...
export class Register extends navigator(LitElement) {
    ...
    render() {
        return html`
            ...
            <br/>
            <div class="signin-container">
                Username: <input id="username" @change=${this.handleInput}/>
            </div>
            <div class="signin-container">
                Full Name: <input id="full_name" @change=${this.handleInput}/>
            </div>
            <div class="signin-container">
                Preferred Name: <input id="preferred_name" @change=${this.handleInput}/>
            </div>
            <div class="signin-container">
                Major: <input id="major" @change=${this.handleInput}/>
            </div>
            <div class="signin-container">
