...
class SubjectsPermissions(permissions.BasePermission):
    def has_permission(self, request, view):
        if view.action in ['list', 'retrieve', 'tutors', 'portfolio_entries', 'projects', 'interactive_projects']:
            return True
    ...
    def has_object_permission(self, request, view, obj):
        if view.action in ['retrieve', 'tutors', 'portfolio_entries', 'projects', 'interactive_projects']:
            return True
